...
/**
 * Just the CIWS's ammo slot plus a plainly-drawn "Ammo: X / Y" readout, so
 * the count is visible at a glance and not just implied by the item icon.
 */
public class CiwsAmmoScreen extends HandledScreen<CiwsAmmoScreenHandler> {
	...
	private static final int PLAYER_INV_Y = CiwsAmmoScreenHandler.PLAYER_INV_Y;

	public CiwsAmmoScreen(CiwsAmmoScreenHandler handler, PlayerInventory inventory, Text title) {
